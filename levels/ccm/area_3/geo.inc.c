...
const GeoLayout ccm_area_3_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_ROTATION_NODE_WITH_DL(LAYER_OPAQUE, 90, 0, 0, ccm_dl_DL_ccm_3_0xe026000_Obj_mesh_layer_1),
		GEO_ROTATION_NODE_WITH_DL(LAYER_ALPHA, 90, 0, 0, ccm_dl_DL_ccm_3_0xe02ff40_Obj_mesh_layer_4),
