void scroll_wf_dl_DL_wf_2_0xe0963a0_Obj_004_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 8;
	int width = 32 * 0x20;
	...
	int deltaX;
	Vtx *vertices = segmented_to_virtual(wf_dl_DL_wf_2_0xe0963a0_Obj_004_mesh_layer_5_vtx_0);
...
void scroll_wf() {
	scroll_wf_dl_DL_wf_2_0xe0963a0_Obj_004_mesh_layer_5_vtx_0();
